...
| **Extreme Gradient Boost (XGBoost)** | A more optimized and improved gradient boost with features like automatic null handling and regularization | Ensemble (Boosting) / Sequential Learning |
